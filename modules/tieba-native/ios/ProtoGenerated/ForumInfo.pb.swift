...
nonisolated extension Tieba_ForumInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _signInInfo: Tieba_ForumSignInfo? = nil
    var _avatar: String = String()
    var _slogan: String = String()
    var _goodClassify: [Tieba_ForumClassify] = []
...
nonisolated extension Tieba_ForumSignInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._forumInfo) }()
      default: break
      }
    }
  }
...
nonisolated extension Tieba_ForumSignUser: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt32Field(value: &self.isSignIn) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.contSignNum) }()
      case 3: try { try decoder.decodeSingularInt32Field(value: &self.userSignRank) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.signBonusPoint) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.signTime) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.contSignNum != 0 {
      try visitor.visitSingularInt32Field(value: self.contSignNum, fieldNumber: 2)
    }
    if self.userSignRank != 0 {
      try visitor.visitSingularInt32Field(value: self.userSignRank, fieldNumber: 3)
    }
    if self.signBonusPoint != 0 {
      try visitor.visitSingularInt32Field(value: self.signBonusPoint, fieldNumber: 4)
    }
    if !self.signTime.isEmpty {
      try visitor.visitSingularStringField(value: self.signTime, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Tieba_ForumSignUser, rhs: Tieba_ForumSignUser) -> Bool {
    ...
    if lhs.signBonusPoint != rhs.signBonusPoint {return false}
...
nonisolated extension Tieba_ForumSignForum: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt32Field(value: &self.signRank) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.memberCount) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.signCount) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.memberCount != 0 {
      try visitor.visitSingularInt32Field(value: self.memberCount, fieldNumber: 2)
    }
    if !self.signCount.isEmpty {
      try visitor.visitSingularStringField(value: self.signCount, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
