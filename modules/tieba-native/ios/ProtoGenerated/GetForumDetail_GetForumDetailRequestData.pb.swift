...
// Source: GetForumDetail/GetForumDetailRequestData.proto
//
...
nonisolated struct Tieba_GetForumDetail_GetForumDetailRequestData: Sendable {
...
nonisolated extension Tieba_GetForumDetail_GetForumDetailRequestData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetForumDetailRequestData"
  ...
  static func ==(lhs: Tieba_GetForumDetail_GetForumDetailRequestData, rhs: Tieba_GetForumDetail_GetForumDetailRequestData) -> Bool {
